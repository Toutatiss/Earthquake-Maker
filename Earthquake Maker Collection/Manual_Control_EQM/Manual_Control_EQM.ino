...
void controlSpeed() {
  control = analogRead(speedControl);
  speedInput = int(control * rangeScaler);
  Serial.println(speedInput);
//  analogWrite(motorEnable, int(speedInput)); // write new pwm signal to motor
}
